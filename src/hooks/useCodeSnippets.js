...
// own generator wraps, so it is the honest single default among the five rows.
...
// generation logic; the snippet text is static data from `snippetsFor`.
//
...
function useCodeSnippets(version) {
